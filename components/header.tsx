    ...
    <header className="relative">
            ...
            <div className="mx-auto max-w-xl-2 lg:mx-0">
              <div className="hidden sm:mb-10 sm:flex">
                <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-foreground ring-1 ring-foreground/10 hover:ring-foreground/20">
                  Start planning your Umrah journey.{" "}
                  <Link
                    href="#umrah-options"
                    className="whitespace-nowrap font-medium text-primary">
                    Existing Packages <span aria-hidden="true">&rarr;</span>
                  </Link>
                </div>
              </div>
              ...
              <div className="mt-10 flex items-center gap-x-4">
                <Button size="lg" asChild>
                  <Link href="/packages-existing">Get started</Link>
                </Button>
      ...
      <div className="relative bg-muted lg:absolute lg:inset-y-0 lg:right-0 lg:z-30 lg:w-1/2">
        <svg
          ...
          aria-hidden="true"
          className="absolute inset-y-0 left-0 z-20 hidden h-full w-80 -translate-x-1/2 transform fill-background lg:block">
        ...
        <Image
          ...
          alt="Umrah"
          fill
          className="!static aspect-[3/2] !h-auto object-cover grayscale lg:aspect-auto lg:!h-full lg:!w-full"
        />
      </div>
    </header>
  )
